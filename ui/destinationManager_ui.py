...
class Ui_destinationManagerWindow(object):
    def setupUi(self, destinationManagerWindow):
        ...
        self.newButton.setMinimumSize(QSize(120, 0))
        ...
        self.previewButton.setMinimumSize(QSize(120, 0))
        ...
        self.addtotravelButton.setMinimumSize(QSize(120, 0))
        ...
        self.exitButton.setMinimumSize(QSize(120, 0))
